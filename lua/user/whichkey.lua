...
wk.add({
    ...
    {"<leader>lk" ,"<cmd>Lspsaga peek_definition<cr>", desc="Peek definition" },
    ...
    {"<leader>dt" ,"<cmd>Trouble document_diagnostics<cr>", desc="trouble" },
    {"<leader>dw" ,"<cmd>Trouble workspace_diagnostics<cr>", desc="workspace" },
    {"<leader>dd" ,"<cmd>Lspsaga show_line_diagnostics<cr>", desc="document" },
